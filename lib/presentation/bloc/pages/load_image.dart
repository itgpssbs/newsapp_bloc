//ada opsi darIO/ darthtml
// pilih dartIO karena berhubungan dengan camera
import 'dart:io';
...
class _LoadImageScreenState extends State<LoadImageScreen>{
  ...
  Widget build(BuildContext context){
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Load Profile picture from camera"),
